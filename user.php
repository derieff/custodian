...
elseif(isset($_POST[add])) {
	...
	$sql= "	INSERT INTO M_User (User_ID,User_Name,User_FullName,User_Email,User_Password,User_Insert_UserID,User_Insert_Time,
			...
			'$_SESSION[User_ID]', sysdate(),'$_SESSION[User_ID]', sysdate(),NULL,NULL,'$_POST[optUser_SPV1]','1','$_POST[optUser_SPV2]')";
	...
	if(mysql_query($sql)){
		$sql1="INSERT INTO M_UserRole (MUR_ID,MUR_UserID,MUR_RoleID,MUR_Insert_UserID,
				...
				VALUES (NULL, '$User_ID','$_POST[optUser_Role]','$_SESSION[User_ID]', sysdate(),'$_SESSION[User_ID]',
						sysdate(),NULL,NULL)";
		...
		$sql3="INSERT INTO M_DivisionDepartmentPosition (DDP_ID,DDP_UserID,DDP_DivID,DDP_DeptID,DDP_PosID,
			   DDP_Insert_UserID,DDP_Insert_Time,DDP_Update_UserID,DDP_Update_Time,DDP_Delete_UserID,DDP_Delete_Time)
				VALUES (NULL, '$User_ID','$_POST[optDDP_DivID]','$_POST[optDDP_DeptID]',
						'$_POST[optDDP_PosID]','$_SESSION[User_ID]', sysdate(),'$_SESSION[User_ID]',
						sysdate(),NULL,NULL)";
	...
	if($_POST['User_Local']){
		...
		if($cRow){
			$sql2="UPDATE M_DivisionDepartmentPosition
				   SET DDP_DeptID='$_POST[optDDP_DeptID]', DDP_DivID='$_POST[optDDP_DivID]',
					   DDP_PosID='$_POST[optDDP_PosID]',DDP_Update_UserID='$_SESSION[User_ID]', DDP_Update_Time=sysdate()
		...
		$sql= "UPDATE M_User
			   SET User_Name='$_POST[txtUser_Name]',User_FullName='$_POST[txtUser_FullName]', User_Email='$_POST[txtUser_Email]',
				   User_Password=$password, User_Update_UserID='$_SESSION[User_ID]', User_Update_Time=sysdate(),
		...
		if($cRow){
			$sql1="UPDATE M_UserRole
				   SET MUR_RoleID='$_POST[optUser_Role]', MUR_Update_UserID='$_SESSION[User_ID]', MUR_Update_Time=sysdate()
				   WHERE MUR_UserID='$_POST[txtUser_ID]'";
		}else{
			$sql1="	INSERT INTO M_UserRole (MUR_ID,MUR_UserID,MUR_RoleID,MUR_Insert_UserID,
					MUR_Insert_Time,MUR_Update_UserID,MUR_Update_Time,MUR_Delete_UserID,MUR_Delete_Time)
					VALUES (NULL,'$_POST[txtUser_ID]','$_POST[optUser_Role]','$_SESSION[User_ID]',sysdate(),
...
elseif(isset($_POST[delete])) {
	$sql= "UPDATE M_User
			SET User_Delete_UserID='$_SESSION[User_ID]', User_Delete_Time=sysdate()
			WHERE User_ID='$_POST[txtUser_ID]'";

	$sql1="UPDATE M_UserRole
			SET MUR_Delete_UserID='$_SESSION[User_ID]', MUR_Delete_Time=sysdate()
			WHERE MUR_UserID='$_POST[txtUser_ID]'";

	$sql2="UPDATE M_DivisionDepartmentPosition
			SET DDP_Delete_UserID='$_SESSION[User_ID]', DDP_Delete_Time=sysdate()
			WHERE DDP_UserID='$_POST[txtUser_ID]'";
