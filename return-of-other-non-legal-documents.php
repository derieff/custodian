...
if(isset($_GET["act"]))
{
	...
	if($act=='detail') {
		...
		$query1 = "SELECT  tdronld.TDRTOONLD_ReturnCode, u.User_FullName, d.Division_Name, dp.Department_Name,
		    			   p.Position_Name, tdronld.TDRTOONLD_ReturnTime, u.User_ID,
						   tdrtoold.TDRTOONLD_Status, drs.DRS_Description, tdrtoold.TDRTOONLD_Reason,
				   ...
				   LEFT JOIN M_Approval m_app
          				ON tdrtoold.TDRTOONLD_ReturnCode=m_app.A_TransactionCode
                        $appQuery
                   LEFT JOIN M_DocumentRegistrationStatus drs
    			        ON tdrtoold.TDRTOONLD_Status=drs.DRS_Name
