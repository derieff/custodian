...
elseif(isset($_POST[add])) {
	$sql= "INSERT INTO M_DocumentType 
				VALUES (NULL,'$_POST[txtDocumentType_Name]','$_SESSION[User_ID]', sysdate(),'$_SESSION[User_ID]', 
						sysdate(),NULL,NULL)";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=document-type.php'>";
	}
...
elseif(isset($_POST[edit])) {
	$sql= "UPDATE M_DocumentType 
				SET DocumentType_Name='$_POST[txtDocumentType_Name]', DocumentType_Update_UserID='$_SESSION[User_ID]', 
...
elseif(isset($_POST[delete])) {
	$sql= "UPDATE M_DocumentType 
				SET DocumentType_Delete_UserID='$_SESSION[User_ID]', DocumentType_Delete_Time=sysdate() 
