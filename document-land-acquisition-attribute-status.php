...
elseif(isset($_POST[add])) {
	$sql= "INSERT INTO M_LandAcquisitionAttributeStatus 
				VALUES (NULL,'$_POST[txtLAAS_Symbol]','$_POST[txtLAAS_Name]','$_SESSION[User_ID]', 
...
elseif(isset($_POST[edit])) {
	$sql= "UPDATE M_LandAcquisitionAttributeStatus 
			SET LAAS_Symbol='$_POST[txtLAAS_Symbol]', LAAS_Update_UserID='$_SESSION[User_ID]', 
...
elseif(isset($_POST[delete])) {
	$sql= "UPDATE M_LandAcquisitionAttributeStatus 
			SET LAAS_Delete_UserID='$_SESSION[User_ID]', LAAS_Delete_Time=sysdate() 
			WHERE LAAS_ID='$_POST[txtLAAS_ID]'";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=document-land-acquisition-attribute-status.php'>";
	}
