...
<?PHP
	...
	$stnk_sdate=date("d M Y", strtotime($arrd['TDROAOD_STNK_StartDate']));
	$stnk_exdate=(($arrd['TDROAOD_STNK_ExpiredDate']=="0000-00-00 00:00:00")||($arrd['TDROAOD_STNK_ExpiredDate']=="1970-01-01 01:00:00"))?"-":date("d M Y", strtotime($arrd['TDROAOD_STNK_ExpiredDate']));

    $pajak_sdate=date("d M Y", strtotime($arrd['TDROAOD_Pajak_StartDate']));
	$pajak_exdate=(($arrd['TDROAOD_Pajak_ExpiredDate']=="0000-00-00 00:00:00")||($arrd['TDROAOD_Pajak_ExpiredDate']=="1970-01-01 01:00:00"))?"-":date("d M Y", strtotime($arrd['TDROAOD_Pajak_ExpiredDate']));
...
<tfoot>
	<tr>
		<td colspan='15' style='font-size:8px;font-weight:bolder;' align='right'><i>PRINTED BY CUSTODIAN SYSTEM VER <?PHP echo $_SESSION['version']?> ON <?PHP echo date("d/m/Y H:i:s")?></i></td>
	</tr>
</tfoot>
</table>
