...
elseif(isset($_POST[add])) {
	$sql= "INSERT INTO M_Menu
			VALUES (NULL,'$_POST[txtMenu_Name]','$_POST[txtMenu_ParentID]','$_POST[txtMenu_Link]',
					'$_POST[txtMenu_Attribute1]','$_POST[txtMenu_Attribute2]','$_POST[txtMenu_Seq]','$_SESSION[User_ID]',
...
elseif(isset($_POST[edit])) {
	$sql= "UPDATE M_Menu
			SET Menu_Name='$_POST[txtMenu_Name]', Menu_ParentID='$_POST[txtMenu_ParentID]',
				...
				Menu_Update_UserID='$_SESSION[User_ID]', Menu_Update_Time=sysdate()
...
elseif(isset($_POST[delete])) {
	$sql= "UPDATE M_Menu
			SET Menu_Delete_UserID='$_SESSION[User_ID]', Menu_Delete_Time=sysdate()
			WHERE Menu_ID='$_POST[txtMenu_ID]'";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=menu.php'>";
	}
