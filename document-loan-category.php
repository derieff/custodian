...
elseif(isset($_POST[add])) {
	$sql= "INSERT INTO M_LoanCategory 
			VALUES (NULL,'$_POST[txtLoanCategory_Name]','$_POST[txtLoanCategory_Description]','$_SESSION[User_ID]', 
...
elseif(isset($_POST[edit])) {
	$sql= "UPDATE M_LoanCategory 
				SET LoanCategory_Name='$_POST[txtLoanCategory_Name]', LoanCategory_Update_UserID='$_SESSION[User_ID]', LoanCategory_Update_Time=sysdate(),
...
elseif(isset($_POST[delete])) {
	$sql= "UPDATE M_LoanCategory 
				SET LoanCategory_Delete_UserID='$_SESSION[User_ID]', LoanCategory_Delete_Time=sysdate() 
				WHERE LoanCategory_ID='$_POST[txtLoanCategory_ID]'";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=document-loan-category.php'>";
	}
