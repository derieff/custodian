...
elseif(isset($_POST[add])) {
	$sql= "INSERT INTO M_LoanDetailStatus 
			VALUES (NULL,'$_POST[txtLDS_Name]','$_POST[txtLDS_Description]','$_SESSION[User_ID]', 
...
elseif(isset($_POST[edit])) {
	$sql= "UPDATE M_LoanDetailStatus 
				SET LDS_Name='$_POST[txtLDS_Name]', LDS_Update_UserID='$_SESSION[User_ID]', LDS_Update_Time=sysdate(),
...
elseif(isset($_POST[delete])) {
	$sql= "UPDATE M_LoanDetailStatus 
				SET LDS_Delete_UserID='$_SESSION[User_ID]', LDS_Delete_Time=sysdate() 
				WHERE LDS_ID='$_POST[txtLDS_ID]'";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=document-status.php'>";
	}
