...
if(isset($_GET["act"])) {
	...
	if($act=='add') {
		...
		<tr>
			<td width='30'>Nama</td>
			<td width='70%'>
				<input name='txtTHLOONLD_UserID' type='hidden' value='$_SESSION[User_ID]'/>
				$field[FullName]
			</td>
		</tr>
		<tr>
...
elseif(isset($_POST['canceldetail'])) {
	$cd_query="UPDATE M_CodeTransaction ct, TH_LoanOfOtherNonLegalDocuments thloonl
			   SET ct.CT_Delete_UserID='$_SESSION[User_ID]',ct.CT_Delete_Time=sysdate(),
			       ...
			       thloonld.THLOONLD_Delete_UserID='$_SESSION[User_ID]',thloonld.THLOONLD_Delete_Time=sysdate(),
			       thloonld.THLOONLD_Update_UserID='$_SESSION[User_ID]',thloonld.THLOONLD_Update_Time=sysdate()
