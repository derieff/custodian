...
$mail->Username   = 'nicholas.budihardja@tap-agri.com';
$mail->Password   = 'tap12345';
$mail->AddReplyTo('no-reply@tap-agri.com','Custodian');

$mail->From       = 'no-reply@tap-agri.com';
$mail->FromName   = 'AAAA';

$mail->AddAddress('aries.sholehudin@tap-agri.com','ARIES');
$mail->AddCC('nicholas.budihardja@tap-agri.com');
