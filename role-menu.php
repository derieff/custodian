...
elseif(isset($_POST[add])) {
	...
	for ($i=0; $i<$jumlah; $i++) {
		$sql= "INSERT INTO M_RoleMenu
			   VALUES (NULL,'$_POST[optRole_ID]','$Menu_ID[$i]','$_SESSION[User_ID]',
...
elseif(isset($_POST[edit])) {
	$sql= "UPDATE M_RoleMenu
		   SET RM_Delete_UserID='$_SESSION[User_ID]', RM_Delete_Time=sysdate()
	...
	if($mysqli->query($sql)) {
		...
		for ($i=0; $i<$jumlah; $i++) {
			$sql= "INSERT INTO M_RoleMenu
				   VALUES (NULL,'$_POST[txtRole_ID]','$Menu_ID[$i]','$_SESSION[User_ID]',
						   sysdate(),'$_SESSION[User_ID]', sysdate(),NULL,NULL)";
			$mysqli->query($sql);
		}
		echo "<meta http-equiv='refresh' content='0; url=role-menu.php'>";
