<?PHP session_start(); ?>
<title>Custodian System | Informasi Dokumen 1</title>
<head>
...
$ActionContent ="
	...
	<th colspan=3>Tambah Informasi Dokumen 1 Baru</th>
	<tr>
...
";
	...
	$query = "SELECT * 
				...
				WHERE DocumentInformation1_ID='$DocumentInformation_ID' 
				AND DocumentInformation1_Delete_Time is NULL 
...
$ActionContent ="
	...
	<table width='100%' id='mytable' class='stripeMe'>
	<th colspan=3>Ubah Informasi Dokumen 1</th>
	<tr>
...
";
	...
	$query = "SELECT * FROM M_DocumentInformation1
				WHERE DocumentInformation1_ID='$DocumentInformation_ID' 
				AND DocumentInformation1_Delete_Time is NULL 
				ORDER BY DocumentInformation1_ID ";
	$sql = mysql_query($query);
...
$ActionContent ="
	...
	<table width='100%' id='mytable' class='stripeMe'>
	<th colspan=3>Anda Ingin Menghapus Informasi Dokumen 1 Berikut?</th>
	<tr>
		<td width='30'>ID Informasi Dokumen</td>
		<td width='70%'>
			<input name='txtDocumentInformation_ID' type='text' value='$field[0]' readonly='true' class='readonly'/>
...
$MainContent ="
	...
	<tr>
		<th>ID Informasi Dokumen 1</th>
		<th>Nama Informasi Dokumen 1</th>
	</tr>
	<tr>
...
if(isset($_POST[cancel])) {
	echo "<meta http-equiv='refresh' content='0; url=document-information1.php'>";
}

elseif(isset($_POST[add])) {
	$sql= "INSERT INTO M_DocumentInformation1
				VALUES (NULL,'$_POST[txtDocumentInformation_Name]','$_SESSION[User_ID]', sysdate(),'$_SESSION[User_ID]',
						sysdate(),NULL,NULL)";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=document-information1.php'>";
	}
...
elseif(isset($_POST[edit])) {
	$sql= "UPDATE M_DocumentInformation1 
				SET DocumentInformation1_Name='$_POST[txtDocumentInformation_Name]', 
				    DocumentInformation1_Update_UserID='$_SESSION[User_ID]', DocumentInformation1_Update_Time=sysdate() 
				WHERE DocumentInformation1_ID='$_POST[txtDocumentInformation_ID]'";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=document-information1.php'>";
	}
	else {
...
elseif(isset($_POST[delete])) {
	$sql= "UPDATE M_DocumentInformation1
				SET DocumentInformation1_Delete_UserID='$_SESSION[User_ID]', DocumentInformation1_Delete_Time=sysdate() 
				WHERE DocumentInformation1_ID='$_POST[txtDocumentInformation_ID]'";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=document-information1.php'>";
	}
