...
elseif(isset($_POST[add])) {
	$sql= "INSERT INTO M_DocumentGroup
				VALUES (NULL,'$_POST[txtDocumentGroup_Name]','$_POST[txtDocumentGroup_Code]','$_SESSION[User_ID]', 
...
elseif(isset($_POST[edit])) {
	$sql= "UPDATE M_DocumentGroup 
				SET DocumentGroup_Name='$_POST[txtDocumentGroup_Name]', DocumentGroup_Update_UserID='$_SESSION[User_ID]', 
...
elseif(isset($_POST[delete])) {
	$sql= "UPDATE M_DocumentGroup 
				SET DocumentGroup_Delete_UserID='$_SESSION[User_ID]', DocumentGroup_Delete_Time=sysdate() 
				WHERE DocumentGroup_ID='$_POST[txtDocumentGroup_ID]'";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=document-group.php'>";
	}
