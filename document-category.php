...
elseif(isset($_POST[add])) {
	$sql= "INSERT INTO M_DocumentCategory 
			VALUES (NULL,'$_POST[txtDocumentCategory_Name]','$_SESSION[User_ID]', sysdate(),'$_SESSION[User_ID]', 
					sysdate(),NULL,NULL)";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=document-category.php'>";
	}
...
elseif(isset($_POST[edit])) {
	$sql= "UPDATE M_DocumentCategory 
			SET DocumentCategory_Name='$_POST[txtDocumentCategory_Name]', 
				DocumentCategory_Update_UserID='$_SESSION[User_ID]', DocumentCategory_Update_Time=sysdate() 
...
elseif(isset($_POST[delete])) {
	$sql= "UPDATE M_DocumentCategory 
			SET DocumentCategory_Delete_UserID='$_SESSION[User_ID]', DocumentCategory_Delete_Time=sysdate() 
			WHERE DocumentCategory_ID='$_POST[txtDocumentCategory_ID]'";
	if($mysqli->query($sql)) {
		echo "<meta http-equiv='refresh' content='0; url=document-category.php'>";
	}
